...
import {
  FaBars, FaBuilding, FaTruck, FaBox, FaMapMarkedAlt,
  FaChartLine, FaGlobe, FaFileExport, FaRobot,
  FaFileInvoice, FaUsers,
} from "react-icons/fa";
    ...
    <div className={`sidebar ${open ? "open" : "collapsed"}`}>
      ...
      <div className="menu">
        {modules.map((m, i) => (
          <div
            key={i}
            className={`item ${location.pathname === m.path ? "active" : ""}`}
